...
```{r}
experiment_slug <- "2023-08-31-class-3-4"
...
```{r}
c3_adaptive_assembly_ratio_plot <- ggplot(
...
ggsave(
  filename = paste0(plot_directory, "c3-adaptive-assembly-ratio.pdf"),
  plot = c3_adaptive_assembly_ratio_plot,
  width = 15,
  height = 10
)
```
...
```{r}
c4_adaptive_assembly_ratio_plot <- ggplot(
...
ggsave(
  filename = paste0(plot_directory, "c4-adaptive-assembly-ratio.pdf"),
  plot = c4_adaptive_assembly_ratio_plot,
  width = 15,
  height = 10
)
```
