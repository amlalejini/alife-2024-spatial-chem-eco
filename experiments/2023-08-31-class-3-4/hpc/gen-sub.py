...
combos.add_val(
    ...
    [
        "-INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class3.dat -SEEDING_PROB .957 -DIFFUSION .07 -PROB_CLEAR 0",
        "-INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class4.dat -SEEDING_PROB .514 -DIFFUSION .456 -PROB_CLEAR .003"
    ]
)
