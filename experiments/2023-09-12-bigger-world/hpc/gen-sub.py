...
combos.add_val(
    ...
    [
        "-INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class1.dat -SEEDING_PROB 1.0 -DIFFUSION 0.549 -PROB_CLEAR 0.01",
        "-INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class2.dat -SEEDING_PROB 0.681 -DIFFUSION 0.652 -PROB_CLEAR 0.01",
        "-INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class3.dat -SEEDING_PROB 0.957 -DIFFUSION 0.07 -PROB_CLEAR 0.01",
        "-INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class4.dat -SEEDING_PROB 0.514 -DIFFUSION 0.456 -PROB_CLEAR 0.003"
    ]
)
