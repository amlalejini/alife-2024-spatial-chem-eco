...
graphs = {
    ...
    "toroidal-lattice": {
        ...
        "args": {"graph_height": 10, "graph_width": 10},
        "shared": True
    },
    "comet-kite": {
        "graph": "comet-kite",
        "args": {"core_size": 40, "num_tails": 20, "additional_tail_nodes": 40},
        "shared": False
    },
    "linear-chain": {
        "graph": "linear-chain",
    ...
    "windmill":{
        "graph": "windmill",
        "args":{"cliques": 10, "clique_size": 10}, 
        "shared": True
        }
    }
...
generators = {
    ...
    "cycle":structs.gen_graph_cycle,
    "wheel":structs.gen_graph_wheel, 
    "windmill":structs.gen_graph_windmill
}
