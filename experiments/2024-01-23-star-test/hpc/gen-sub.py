...
combos.add_val(
    ...
    [
        ...
        "-GROUP_REPRO_SPATIAL_STRUCTURE_FILE ${CONFIG_DIR}/spatial-structures/graph-graph_cycle.mat -DIFFUSION_SPATIAL_STRUCTURE_FILE ${CONFIG_DIR}/spatial-structures/graph-cycle.mat",
...
combos.add_val(
   ...
   [
    "-N_TYPES 15 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/1464_diet-composition.csv",
    "-N_TYPES 16 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/1473_diet-composition.csv",
    "-N_TYPES 14 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/1512_diet-composition.csv",
    "-N_TYPES 9 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class1.dat",
    "-N_TYPES 9 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class2.dat",
    "-N_TYPES 9 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class3.dat",
    "-N_TYPES 9 -INTERACTION_SOURCE ${CONFIG_DIR}/interaction-matrices/class4.dat"
